...
const currentPage = ref('home'); // Track the current page
            ...
            <nav class="">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink :href="route('update')" :active="route().current('update')">
                ...
                >
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                                ...
                                <ResponsiveNavLink :href="route('update')" :active="route().current('update')">
                                    Data Update:  <LastUpdateText :lastUpdate="lastUpdate" />
                                </ResponsiveNavLink>
                    </div> 
